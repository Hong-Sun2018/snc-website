        ...
        <Container>
          <Box maxWidth={{ xs: 1, sm: '50%' }}>
            ...
            >
              ...
              >
                <Typed
                  strings={['global edge computing resources.', 'cloud-edge-IoT collaboration.']}
                  typeSpeed={80}
                  loop={true}
                />
              </Typography>
            ...
            <Typography
              ...
              marginTop="20px"
            >
              Gather global computing resources to enable&nbsp;
                <Typography component="span" variant="inherit" color="primary" fontWeight="bold">
                  Metaverse
                </Typography>
                .
            </Typography>
            ...
            >
              ...
              >
                <Button
                  ...
                  size="large"
                  fullWidth={isMd ? false : true}
                  style={{color: 'white', borderColor:'white', fontWeight:'bold'} }
                >
                  Contact us
                </Button>
              </Box>
